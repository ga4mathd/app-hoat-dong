  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-36 sm:bottom-28 right-4 z-40 w-12 h-12 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center justify-center animate-[bounce-scale_1.5s_ease-in-out_infinite]"
      >
